...
def product_create(request):
    ...
    try:
        ...
        if cost_price < 0 or selling_price <= 0 or reorder_level < 0:
            raise ValueError("Cost/reorder values cannot be negative and selling price must be greater than zero.")
...
def stock_adjust(request):
    ...
    try:
        ...
        StockMovement.objects.create(
            ...
            quantity=qty,
            unit_cost=product.get_moving_average_cost() or product.cost_price,
            reference_document='OPENING/ADJUST',
